  ...
  return (
    <div className='nav-admin'>
        ...
        <div className='toggle-nav-ad'>
            <Link to='/admin/' className={`d-flex ${activeSelect == "DASHBOARD"? "active-toggle" : ""}`}>
                <img src={activeSelect == "DASHBOARD"? DashboardActive : DashboardDisable}/>
                <p>Dashboard</p>
            </Link>
            <Link to='/admin/daftar-penitipan' className={`d-flex ${activeSelect == "PENITIPAN"? "active-toggle" : ""}`}>
                <img className=''  src={activeSelect == "PENITIPAN"? PenitipanActive : PenitipanDisable}/>
                <p className=''>Penitipan</p>
            </Link>
            <Link to='/admin/transaksi' className={`d-flex ${activeSelect == "TRANSAKSI"? "active-toggle" : ""}`}>
